...
export const categoriesModel = {
  selectCategoryTable: selectCategorySchema,
  // 创建分类请求参数
  insertCategoryDto: insertCategorySchema.omit({ id: true, createdAt: true, updatedAt: true }),
  
  updateCategoryDto: updateCategorySchema.omit({ id: true, createdAt: true, updatedAt: true }),
...
export type InsertCategoryDto = z.infer<typeof categoriesModel.insertCategoryDto>;  // 请求用
export type UpdateCategoryDto = z.infer<typeof categoriesModel.updateCategoryDto>;  // 请求用
export type SelectCategoryType = z.infer<typeof categoriesModel.selectCategoryTable>; // 查询返回原始类型
export type CategoryListQueryDto = z.infer<typeof categoriesModel.queryCategoryListDto>;
export type CategoryTreeQueryDto = z.infer<typeof categoriesModel.queryCategoryTreeDto>;
