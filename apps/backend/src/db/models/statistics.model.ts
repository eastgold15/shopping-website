...
export const insertStatisticsSchema = createInsertSchema(statisticsTable, {
  ...
  type: z.string().min(1, "统计类型不能为空").max(50, "统计类型不能超过50个字符"),
...
export type InsertStatisticsDto = z.infer<typeof statisticsModel.insertStatisticsDto>;
export type UpdateStatisticsDto = z.infer<typeof statisticsModel.updateStatisticsDto>;
export type SelectStatisticsType = z.infer<typeof statisticsModel.selectStatisticsTable>;
export type StatisticsListQueryDto = z.infer<typeof statisticsModel.queryStatisticsListDto>;
export type StatisticsOverviewDto = z.infer<typeof statisticsModel.statisticsOverviewDto>;
export type StatisticsChartDto = z.infer<typeof statisticsModel.statisticsChartDto>;
export type BatchInsertStatisticsDto = z.infer<typeof statisticsModel.batchInsertStatisticsDto>;
