...
export const attributesModel = {
  ...
  insertColorDto: insertColorSchema.omit({ id: true, createdAt: true, updatedAt: true }),
  updateColorDto: updateColorSchema.omit({ id: true, createdAt: true, updatedAt: true }),
  ...
  insertSizeDto: insertSizeSchema.omit({ id: true, createdAt: true, updatedAt: true }),
  updateSizeDto: updateSizeSchema.omit({ id: true, createdAt: true, updatedAt: true }),
...
export type ColorListQueryDto = z.infer<typeof attributesModel.queryColorListDto>;
