...
export const insertProductStatisticsSchema = createInsertSchema(
	productStatisticsTable,
);
export const selectProductStatisticsSchema = createSelectSchema(
	productStatisticsTable,
);
export const updateProductStatisticsSchema = createUpdateSchema(
	productStatisticsTable,
);
...
// 4. 类型定义
export type InsertProductStatisticsDto = z.infer<
	typeof productStatisticsModel.insertProductStatisticsDto
>;
export type UpdateProductStatisticsDto = z.infer<
	typeof productStatisticsModel.updateProductStatisticsDto
>;
export type SelectProductStatisticsType = z.infer<
	typeof productStatisticsModel.selectProductStatisticsTable
>;
export type ProductStatisticsListQueryDto = z.infer<
	typeof productStatisticsModel.queryProductStatisticsListDto
>;
export type ProductStatisticsOverviewDto = z.infer<
	typeof productStatisticsModel.productStatisticsOverviewDto
>;
export type PopularProductsDto = z.infer<
	typeof productStatisticsModel.popularProductsDto
>;
