...
export const selectAdvertisementsSchema = createSelectSchema(advertisementsTable);

// 广告模型定义
export const advertisementsModel = {
  selectAdvertisementsTable: selectAdvertisementsSchema,
  // 创建广告请求参数
  insertAdvertisementsDto: insertAdvertisementsSchema.omit({ id: true, clickCount: true, viewCount: true, createdAt: true, updatedAt: true }),

  updateAdvertisementsDto: updateAdvertisementsSchema.omit({ id: true, clickCount: true, viewCount: true, createdAt: true, updatedAt: true }),
...
export type InsertAdvertisementsDto = z.infer<typeof advertisementsModel.insertAdvertisementsDto>;  // 请求用
export type UpdateAdvertisementsDto = z.infer<typeof advertisementsModel.updateAdvertisementsDto>;  // 请求用
export type SelectAdvertisementsType = z.infer<typeof advertisementsModel.selectAdvertisementsTable>; // 查询返回原始类型
export type AdvertisementsListQueryDto = z.infer<typeof advertisementsModel.queryAdvertisementsListDto>;
export type AdvertisementsByPositionQueryDto = z.infer<typeof advertisementsModel.queryAdvertisementsByPositionDto>;
export type UpdateAdvertisementStatsDto = z.infer<typeof advertisementsModel.updateAdvertisementStatsDto>;
