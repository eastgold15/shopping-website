...
export const reviewsModel = {
  ...
  // 创建评价请求参数
  insertReviewDto: insertReviewSchema.omit({ id: true, createdAt: true, updatedAt: true }),
  
  updateReviewDto: updateReviewSchema.omit({ id: true, createdAt: true, updatedAt: true }),
...
export type ReviewListQueryDto = z.infer<typeof reviewsModel.queryReviewListDto>;
export type ReviewStatsQueryDto = z.infer<typeof reviewsModel.queryReviewStatsDto>;
