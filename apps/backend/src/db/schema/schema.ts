...
export const productsSchema = pgTable("products", {
	...
	materials: json("materials").default([]),
	...
	metaKeywords: varchar("meta_keywords", { length: 500 }).default(""),
	createdAt: timestamp("created_at").defaultNow(),
	updatedAt: timestamp("updated_at").defaultNow(),
});
...
export const ordersSchema = pgTable("orders", {
	...
	shippingMethod: varchar("shipping_method", { length: 50 }).default(""),
...
export const orderItemsSchema = pgTable("order_items", {
	...
	productSku: varchar("product_sku", { length: 100 }).default(""),
	productImage: text("product_image").default(""),
	unitPrice: decimal("unit_price", { precision: 10, scale: 2 }).notNull(),
	quantity: integer("quantity").notNull(),
	totalPrice: decimal("total_price", { precision: 10, scale: 2 }).notNull(),
	selectedColor: varchar("selected_color", { length: 50 }).default(""),
	selectedSize: varchar("selected_size", { length: 50 }).default(""),
	productOptions: json("product_options").default({}), // 其他商品选项
	createdAt: timestamp("created_at").defaultNow(),
	updatedAt: timestamp("updated_at").defaultNow(),
});
...
export const refundsSchema = pgTable("refunds", {
	...
	refundMethod: varchar("refund_method", { length: 50 }).default(""),
