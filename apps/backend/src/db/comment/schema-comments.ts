...
import { pgComments, runPgComments } from "./comment.plugin.js";

// 为用户表添加注释
pgComments(usersTable, {
	id: "用户ID，主键",
	username: "用户名，唯一",
	password: "密码，加密存储",
	email: "电子邮件，唯一",
...
// 为广告管理表添加注释
pgComments(advertisementsTable, {
	id: "广告ID，主键",
	title: "广告标题",
