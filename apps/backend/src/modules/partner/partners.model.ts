...
export const partnersModel = {
	// 创建合作伙伴请求参数
	CreatePartnerDto: t.Omit(DbType.typebox.insert.partnersSchema, [
		"id",
		"createdAt",
		"updatedAt",
		"sortOrder",
...
export type PartnerModel =
	typeof DbType.typebox.select.partnersSchema.static & { image: string };
