...
export type CreateADDto =
  typeof advertisementsModel.CreateADDto.static;
export type UpdateADDto =
  typeof advertisementsModel.UpdateADDto.static;
export type ADQueryDto =
  typeof advertisementsModel.ADQueryDto.static;
