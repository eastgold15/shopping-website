...
export const categoriesModel = {
  // 创建分类请求参数
  CreateCategoryDto: t.Omit(DbType.typebox.insert.categoriesSchema, ['id', 'createdAt', 'updatedAt']),

  // 更新分类请求参数
  UpdateCategoryDto: t.Omit(DbType.typebox.insert.categoriesSchema, ['id', 'createdAt', 'updatedAt']),
  // 排序更新请求
  ...
  // 统一查询参数
  UnifiedQueryParams: t.Composite([UnoQuery, t.Object({
...
export type UnifiedQueryParams = typeof categoriesModel.UnifiedQueryParams.static;
