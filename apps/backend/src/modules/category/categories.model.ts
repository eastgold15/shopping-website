...
export type CategoriesQueryDTO = typeof categoriesModel.CategoriesQuery.static;

export type CategoriesModel = typeof DbType.typebox.select.categoriesSchema.static