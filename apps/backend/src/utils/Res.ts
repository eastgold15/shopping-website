 ...
 * 分页结果 Zod 类型定义工厂
 */
export const createPaginationResultZod = <T extends z.ZodTypeAny>(
	itemSchema: T,
) => {
	return z.object({
		code: z.number(),
 ...
 */
export const makeOptional = <T extends z.ZodRawShape>(
 ...
 */
export const makeRequired = <T extends z.ZodRawShape>(
	schema: z.ZodObject<T>,
) => {
