...
<template>
  <PrimeCrudTemplate name="分类" identifier="partner" :table-data="tableData"
    :template-data="templateData" :crud-controller="15" :query-form="queryForm" :resolver="resolver"
    :query-resolver="queryResolver" :useTreeTable="true" :expandedKeys="expandedKeys" :tree-data="treeTableData">
    <!-- 查询表单 -->
    <template #QueryForm>
